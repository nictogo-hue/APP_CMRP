...
const navItems: NavItem[] = [
  ...
  { href: '/exam/new', label: 'Simulacro CMRP', icon: ClipboardIcon, roles: ['admin', 'lawyer', 'client'] },
  { href: '/tutor', label: 'Tutor IA', icon: BrainIcon, roles: ['admin', 'lawyer', 'client'] },
  { href: '/analytics', label: 'Mi Progreso', icon: ChartBarIcon, roles: ['admin', 'lawyer', 'client'] },
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        {isLoading ? (
          ...
          <>
            ...
            {/* Sección Admin */}
            {userRole === 'admin' && filteredNavItems.length > 6 && (
